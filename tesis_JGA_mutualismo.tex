...
El mutualismo es un tipo de interacción ecológica que resulta beneficiosa para ambas especies. La polinización es el ejemplo típico. Los polinizadores se alimente del néctar, polen o aceite que proporcionan las plantas y, a cambio, permiten la fertilización floral al dispersar el polen.
...
La ciencia de redes ha demostrado ser una herramienta útil para entender mutualismo, siguiendo los pasos de su aplicación con éxito en otras áreas del modelado ecológico como las \textit{food webs}. La estructura de la red determina la dinámica de las poblaciones y la resistencia global del sistema.

En esta tesis describimos algunas contribuciones para la comprensión del mutualismo basadas en la ciencia de redes. 
