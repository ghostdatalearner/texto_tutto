...
El mutualismo es un tipo de interacción ecológica que resulta beneficiosa para ambas especies. La polinización es el ejemplo típico. Los polinizadores se alimentan del néctar, polen o aceite que producen las plantas y, a cambio, permiten la fertilización floral al dispersar el polen.

El estudio de las comunidades mutualistas es un campo de investigación muy activo. Los datos disponibles crecen gracias al esfuerzo de los ecólogos de campo. Estos datos son vitales para probar las hipótesis que intentan modelar este tipo de relación.

La ciencia de redes ha demostrado ser una herramienta útil en el terreno de las interacciones ecológicas, siguiendo los pasos de su aplicación con éxito en el modelado de otras comunidades como las \textit{food webs}. La estructura de la red determina la dinámica de las poblaciones y la resistencia global del sistema.
...
In this thesis we describe some contributions based on network science to improve the understanding of this kind of relationship. 
