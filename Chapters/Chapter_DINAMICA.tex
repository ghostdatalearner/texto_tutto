...
\caption {Comunidad mutualista con cinco especie de plantas y cinco de polinizadores.}
...
\begin{figure}[ht!]
\centering
\includegraphics[scale = 0.5]{DINAMICA_Fig6_carrying_cap.eps}
\caption {Evolución temporal de las poblacoines y de las tasas de crecimiento efectivas del mismo sistema de $4+5$ species (figura \ref{fig:red_exper_stab1}). La comunidad termina con todas las especies en sus capacidades de carga respectivas.}
...
\begin{figure}[h!]
\centering
\includegraphics[scale = 0.5 ]{DINAMICA_Fig7_partial_extinct.eps}
...
\section{Anexo: Datos de las simulaciones del modelo con $K$ constantes}
