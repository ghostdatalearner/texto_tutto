...
Citando una figura de otro capítulo. Como se ve en la figura \ref{fig:VISUALIZACION_zigurat}
Citando una fórmula de otro capítulo. Como se ve en la fórmula \ref{eq:reffs_2especies}
