...
Podemos definir una magnitud global, que proporcione una idea de la dispersión de los nodos respecto del núcleo estable de la red, identificado con la \textit{shell} máxima. Para ello, se promedian los los $k_{radius}$ de todas las especies.
...
\begin{figure}[htp!]
\centering
\includegraphics[scale=0.62]{ESTATICA_zscores_networks_evolution.png}
